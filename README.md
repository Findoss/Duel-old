...
При использовании умения использующей сигму энергию уменьшается только сигма энергия на значение указанное в атрибуте умения.  
...
Игрок может выбирать умения за очки мастерства в [дереве умений](#Дерево-умений).  
