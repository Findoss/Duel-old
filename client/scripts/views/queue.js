/**
 * TODO
 * Разобрать строку запуска анимации
 */
/**
 * Очередь команд/анимаци
 * ** ! ВАЖНО ** функции могут вставать в очередь в блокирущем режиме только если
 * возвращают `Phaser.Tween`
 * или `Phaser.Animation`
 * или вызывают событие `onComplete` (`Phaser.Signal`)
 * @class
 * @fires Queue
 */
class Queue {
